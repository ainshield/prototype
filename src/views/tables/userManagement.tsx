...
interface Column {
  id: 'id' | 'programid' | 'roleid' | 'permissionid' | 'username' | 'password' |
...
const rows = [
  ...
  createData(2, 13662724, 215161, 6246136, 'johndoe', 'foobar1234',
    'John', ' ', 'Doe',0, '09123456789', 'johndoe@example.com',
    'employee', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.'),
  createData(3, 13662724, 215161, 6246136, 'johndoe', 'foobar1234',
    'John', ' ', 'Doe',0, '09123456789', 'johndoe@example.com',
    'employee', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.')
]
